...
INPUT_STYLE_ANALYSIS_PROMPT = Prompt("""You are an AI assistant helping to analyze the style of example inputs for a RAG system.
...
STYLE_ANALYSIS_PROMPT = Prompt("""You are an AI assistant helping to analyze the style of example inputs for a RAG (Retrieval-Augmented Generation) system.
...
Provide a detailed analysis of:
1. Input types and structures
2. Grammatical patterns
3. Vocabulary and formality level
4. Distinctive style elements

Format your response as a JSON object with these keys:
- input_types: Object with frequencies of different input types
- grammar_patterns: Array of common grammatical structures
- vocabulary_level: String describing vocabulary (e.g., "technical", "conversational")
- formality_level: Number from 0-1 where 0 is very informal and 1 is very formal
- distinctive_elements: Array of distinctive style elements to replicate
...
ADAPTIVE_INPUT_GENERATION_PROMPT = Prompt("""You are an AI assistant helping to generate inputs for evaluating a RAG system.
...
INPUT_GENERATION_PROMPT = Prompt("""You are an AI assistant helping to generate inputs for evaluating a RAG (Retrieval-Augmented Generation) system.
...
REFERENCE_ANSWER_PROMPT = Prompt("""You are an AI assistant helping to generate reference answers for evaluating a RAG (Retrieval-Augmented Generation) system.
